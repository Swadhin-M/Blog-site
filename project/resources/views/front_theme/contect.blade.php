...
<div class="hallo">
<button type="button" class="btn btn-warning">{{session()->get('message')}}</button>
            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">{{ $item->contect_number }}</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">{{ $item->email }}</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text"> {{ $item->address }}</span>
                    </div>
                    @endforeach
                    <div class="clearfix"></div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form" action="{{ url('/contect/data') }} " method="POST">
                    @csrf
                    <div class="col-12 py-3">

                        <input type="text" class="form-control fh5co_contact_text_box" name="full_name" placeholder="Enter Your Name" />
                    </div>
                    <div class="col-6 py-3">
                        <input type="text" class="form-control fh5co_contact_text_box" name="email" placeholder="E-mail" />
                    </div>
                    <div class="col-6 py-3">
                        <input type="text" class="form-control fh5co_contact_text_box" name="subject" placeholder="Subject" />
                    </div>
                    <div class="col-12 py-3">
                        <textarea class="form-control fh5co_contacts_message" name="massage" placeholder="Message"></textarea>
                    </div>
                    <div class="col-12 py-3 text-center"> <button type="submit" class="btn btn-primary"> Send Message</button> </div>
                </form>
            </div>
